...
#SBATCH --output=/groups/gerlich/labinfo/Papers/2025_ReplChromConf/analysis/assets/bams_downsampled/logs/downsample_reps%a.out
#SBATCH --error=/groups/gerlich/labinfo/Papers/2025_ReplChromConf/analysis/assets/bams_downsampled/logs/downsample_reps%a.err
...
target_reads=60000000

#Set seed for downsampling for reproducibility
seed=42

case ${SLURM_ARRAY_TASK_ID} in
	1) path="WT_G1/bio_rep1" name="RAD21_WT_G1_BR1";;
	2) path="WT_G1/bio_rep2" name="RAD21_WT_G1_BR2";;
	3) path="WT_G2/bio_rep1" name="RAD21_WT_G2_BR1";;
	4) path="WT_G2/bio_rep2" name="RAD21_WT_G2_BR2";;
